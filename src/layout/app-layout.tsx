...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiTruck } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'customer-service-representative'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Product', path: '/products', entity: 'product', service: AccessServiceEnum.PROJECT, icon: FiBox },
